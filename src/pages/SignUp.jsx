...
const SignUp = () => {
    ...
    const hanldeSignUp=(e)=>{
        ...
        if(password.length < 4){
            setInputValidation('please enter strong password and minimus 6 cherector')
            return;
        }
        ...
        <div className="flex h-screen items-center justify-center bg-[#8EA7E9]/20 p-6 md:p-0">
          <div className="flex h-full w-full overflow-hidden rounded-xl shadow-md  md:h-[90%] md:w-[80%] lg:h-[80%]">
            ...
            <div className="flex w-full flex-col justify-center bg-white py-10 lg:w-[60%]">
              ...
              <form onSubmit={hanldeSignUp} className="flex  w-full flex-col items-center justify-center gap-4">
                <input
                ...
                <input
                  ...
                  name="password"
                />
                {inputValidation && <p className="text-red-500 font-normal font-bold">{inputValidation}</p>}
                <p className="text-[14px] text-gray-400">
                  Do have an account ?{" "}
                  <Link to='/login' className="text-[#8EA7E9] "> plase login</Link>
                </p>
                <input
